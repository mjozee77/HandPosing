...
class HandGestureProcessor {
    ...
    typealias PointsPair = (thumbTip: CGPoint, indexTip: CGPoint, middleTip: CGPoint, ringTip: CGPoint, littleTip: CGPoint, thumbIP: CGPoint, thumbMP: CGPoint, thumbCMC: CGPoint, indexDIP: CGPoint, indexPIP: CGPoint, indexMCP: CGPoint, middleDIP: CGPoint, middlePIP: CGPoint, middleMCP: CGPoint, ringDIP: CGPoint, ringPIP: CGPoint, ringMCP: CGPoint, littleDIP: CGPoint, littlePIP: CGPoint, littleMCP: CGPoint, wrist: CGPoint)
   ...
   private (set) var lastProcessedPointsPair = PointsPair(.zero, .zero, .zero, .zero, .zero, .zero, .zero, .zero, .zero, .zero, .zero, .zero, .zero, .zero, .zero, .zero, .zero, .zero, .zero, .zero, .zero)
